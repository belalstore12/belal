<div class="page" data-name="new">
    ...
    <div class="navbar-inner sliding">
      <div class="left">
        <a href="/main/" class="link back">
          ...
          <span class="if-not-md">بیلال ستۆر </span>
        </a>
      </div>
  ...
  <div class="white-back page-content">
    <div class="block-title block-title-medium" style="text-align: right">2023/4/22</div>
    <div class="block">
      <p style="text-align: right">
        وەک دەزانن من هەڵستام  بە دانانی بیلال ستۆری بو
        <br>
        <br>
